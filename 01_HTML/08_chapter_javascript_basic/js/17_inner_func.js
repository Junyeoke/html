...
// 사용법 : 변수명.toFixed(자리수);
// let x = 12.4763;
// console.log(x.toFixed(2)); // 둘째자리수에서 자르기
...
// console.log("str.substring", str.substring(4, 8)); // "무너져도" 출력
...
// 올림(첫째자리), ceil(천장)
// 사용법 : Math.ceil(실수) -> 올림된 정수
console.log("Math.ceil", Math.ceil(5.3));

// 내림(첫째자리), floor(천장)
// 사용법 : Math.floor(실수) -> 내림된 정수
